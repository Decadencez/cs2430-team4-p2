...
|-|-|-|
|Bryan Estrada|Implementation Lead|Repo setup, /docs, ProjectPlan, design artifacts, README, CONTRIBUTIONS.md, integration, main branch health|
|John McElprang|Developer|MergeSort, QuickSort, PermutationGenerator, ProjectDriver|
|Zachary Tucker|Developer|ShakerSort, HeapSort, SortingAlgorithm interface, SortResult|
...
|src/team4/ShakerSort.java|Zachary|src/team4/ShakerSort.java|
|src/team4/HeapSort.java|Zachary|src/team4/HeapSort.java|
|src/team4/PermutationGenerator.java|John|src/team4/PermutationGenerator.java|
